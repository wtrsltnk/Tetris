...
LDLIBSOPTIONS=-lsfml-graphics -lsfml-window -lsfml-system -lGLU
...
${OBJECTDIR}/Matrix4x4.o: Matrix4x4.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Matrix4x4.o Matrix4x4.cpp
...
${OBJECTDIR}/Vector3.o: Vector3.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Vector3.o Vector3.cpp
